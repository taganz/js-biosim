...
const selectionMethod = new InsideReproductionAreaSelection();
world.obstacles = [
    new RectangleObject(world, 0, 0.3, 0.7, 0.1),
    new RectangleObject(world, 0.8, 0.8, 0.2, 0.2),
  ];
  world.areas = [
    new RectangleReproductionArea(world, 0, 0, 0.35, 0.35, true),   // RD
  ];
*/
...
world.obstacles = [
  //  new RectangleObject(world, 0, 0, 0.2, 0.2),
    new RectangleObject(world, 0.35, 0, 0.65, 0.25),    // barra vertical
    new RectangleObject(world, 0, 0.4, 0.7, 0.1),     // barra horitzontal
    new RectangleObject(world, 0.8, 0.8, 0.2, 0.2),
  ];
  world.areas = [
    new RectangleReproductionArea(world, 0, 0, 0.35, 0.35, true),   // RD
...
world.obstacles = [
  //  new RectangleObject(world, 0, 0, 0.2, 0.2),
    new RectangleObject(world, 0.35, 0, 0.65, 0.25),    // barra vertical
    new RectangleObject(world, 0, 0.4, 0.7, 0.6),     // barra horitzontal
  ];
  world.areas = [
    new RectangleReproductionArea(world, 0, 0, 0.35, 0.35, true),   // RD
  ];
...
// 24/2/24
//const populationStrategy = new AsexualRandomPopulation();
const populationStrategy = new AsexualZonePopulation(); 
world.xrPopulate = 0.8;
world.yrPopulate = 0.6;
world.initialPopulation = 300;
const selectionMethod = new InsideReproductionAreaSelection();
world.obstacles = [
  //  new RectangleObject(world, 0, 0, 0.2, 0.2),
    new RectangleObject(world, 0.35, 0, 0.65, 0.25),    // barra vertical
